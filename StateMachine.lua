...
function StateMachine:checking(x,y)
	self.current:checking(x,y)
end
...
function StateMachine:check_key_released(key)
	self.current:check_key_released(key)
end

function StateMachine:check_key_pressed(key)
	self.current:check_key_pressed(key)
end
